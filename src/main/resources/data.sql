...
-- Audit Logs
INSERT INTO audit_log (action, entity, changed_by, timestamp, organization_id) VALUES
('CREATE', 'ticket', 'alice@acme.com', NOW(), 1),
('UPDATE', 'user', 'judy@kappa.com', NOW(), 10),
('DELETE', 'faq', 'olivia@nu.com', NOW(), 13);
